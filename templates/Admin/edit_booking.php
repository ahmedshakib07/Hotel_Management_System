...
<body class="sb-nav-fixed">
    ...
    <!-- form itself start-->
        <form id="test-form" class="white-popup-block mfp-hide" method="POST" action="<?= PROJECT_ROOT ?>admin/edit_booking/<?= $data['id'] ?>">
                <div class="popup_box">
                        <div class="popup_inner">
                            ...
                            <h3>Edit Booking</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <input style="margin: 0 0 17px 0" type="text" id="default-select" class="form-control" placeholder="Name" name="name" value="<?=$data['name']?>">
                                    </div>

                                    <div class="col-xl-6">
                                        <input style="margin: 0 0 17px 0" type="text" id="default-select" class="form-control" placeholder="Phone" name="phone" value="<?=$data['phone']?>">
                                    </div>

                                    <div class="col-xl-6">
                                        <input style="margin: 0 0 17px 0" type="email" id="default-select" class="form-control" placeholder="Email" name="email" value="<?=$data['email']?>">
                                    </div>

                                    <div class="col-xl-6">
                                        <input style="margin: 0 0 17px 0" id="datepicker" id="default-select" class="form-control" placeholder="Check in date" name="checkIn" value="<?=$data['checkIn']?>">
                                    </div>

                                    <div class="col-xl-6">
                                        <input style="margin: 0 0 17px 0" id="datepicker2" id="default-select" class="form-control" placeholder="Check out date" name="checkOut" value="<?=$data['checkOut']?>">
                                    </div>

                                    <div class="col-xl-6">
                                        <input style="margin: 0 0 17px 0" id="datepicker2" id="default-select" class="form-control" placeholder="Status" name="status" value="<?=$data['status']?>">
                                    </div>

                                    <div class="col-xl-6">
                                        <select style="margin: 0 0 17px 0" class="form-select wide" id="default-select" name="adult" value="<?=$data['adult']?>">
                                    ...
                                    <div class="col-xl-6">
                                        <select style="margin: 0 0 17px 0" class="form-select wide" id="default-select" name="children" value="<?=$data['children']?>">
                                    ...
                                    <div class="col-xl-12">
                                        <select style="margin: 0 0 17px 0" class="form-select wide" id="default-select" name="roomType" value="<?=$data['roomType']?>">
